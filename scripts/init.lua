...
function mod:init(self)
	...
	--NAH_Hek_InvisibleInc_repairApi = require(mod.scriptPath.. "replaceRepair/api")
...
function mod:load(self,options,version)
	NAH_Hek_InvisibleInc_ModApiExt:load(self, options, version)
	NAH_Hek_InvisibleInc_repairApi:load(self, options, version)
	
	
	require(mod.scriptPath .."replaceRepair/api"):load()
	require(mod.scriptPath .."weaponPreview/api"):load()
